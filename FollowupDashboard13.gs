function importDistributionData10() {
  ...
  var sourceSh = sourceSS.getSheetByName("expiredclients"); // ورقة المصدر

  var targetSS = SpreadsheetApp.openById(targetId);
  var targetSh = targetSS.getSheetByName("expiredclients2"); // ورقة الهدف
